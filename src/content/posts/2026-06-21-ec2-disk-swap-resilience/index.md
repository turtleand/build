...
After expanding the EBS volume in AWS, verify the block device and partition names on the instance. NVMe device names can vary by instance and AMI, so do not paste commands blindly.

A common root-volume shape looks like this:
